package org.loyaltyrex.server.core.persistence.config;
...
import org.loyaltyrex.server.core.persistence.impl.BusinessRepository;
...
public class PgRepositoryConfiguration {
    ...
    public IBusinessRepository businessRepository(BasicDataSource dataSource) {
        return new BusinessRepository(dataSource);
    }
